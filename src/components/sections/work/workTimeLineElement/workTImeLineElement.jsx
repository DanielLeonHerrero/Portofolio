...
const WorkTimeLineElement = (props) => {
    ...
    return (
        <div className={`absolute h-auto w-screen md:w-96 bg-white shadow-md  top-5 lg:p-4 lg:top-[-1rem] ${isEven  ? 'lg:right-20' : 'lg:left-20'} dark:shadow-gray-700 dark:bg-gray-900 dark:text-white`}>
            <div className='p-12'>
